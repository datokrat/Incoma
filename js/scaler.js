define(['event'], function(Events) {
	...
	function Scaler() {
		...
		this.viewPortChanged = new Events.EventImpl();
	    ...
	    this.zoomin = function() {
	        ...
	        sendViewPortEvent(THIS.zoomduration);
	    };
	   ...
	   function sendViewPortEvent(transitionTime) {
	   		THIS.viewPortChanged.raise({ translate: { x: THIS.despx, y: THIS.despy}, zoom: THIS.zoomval, transitionTime: transitionTime });
	   }
	}
	return Scaler;
});